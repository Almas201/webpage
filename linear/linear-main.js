...
function linear() {
    var lambda = document.getElementById('idAA').value;
    alert("Вы ввели " + lambda);
    ...
    while (j <= month) {
        var z = Math.random();
        x.push(parseInt((2/(1/lambda))*(1-Math.sqrt(z))));
        j += 1;
    }
    ...
    document.getElementById('linear-body').appendChild(table);
